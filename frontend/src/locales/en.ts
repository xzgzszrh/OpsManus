export default {
  ...
  'Configure BigModel MCP server API keys. Servers without key will stay disabled.': 'Configure BigModel MCP server API keys. Servers without key will stay disabled.',
  'Enabled': 'Enabled',
  'Disabled': 'Disabled',
  'Saving...': 'Saving...',
  'Save MCP Settings': 'Save MCP Settings',
  'MCP settings saved': 'MCP settings saved',
  'MCP Tool': 'MCP Tool',
  ...
  'No MCP server metadata': 'No MCP server metadata',
  'Call': 'Call',
  'Search Query': 'Search Query',
  'Links': 'Links',
  'No structured search links found in response.': 'No structured search links found in response.',
  'Source URL': 'Source URL',
  'Title': 'Title',
  'Extracted Content': 'Extracted Content',
  'Repository': 'Repository',
  'Image Input': 'Image Input',
  'Send images with requirements and get concrete visual understanding results.': 'Send images with requirements and get concrete visual understanding results.',
  'Web search MCP optimized for retrieval with lower token cost than browser crawling.': 'Web search MCP optimized for retrieval with lower token cost than browser crawling.',
  'Fetch URL content and return structured, model-friendly text extraction.': 'Fetch URL content and return structured, model-friendly text extraction.',
  'Analyze GitHub repositories, file structures, and source code content.': 'Analyze GitHub repositories, file structures, and source code content.',
  'Best for image understanding tasks.': 'Best for image understanding tasks.',
  'Best for web search and quick source discovery.': 'Best for web search and quick source discovery.',
  'Best for webpage content extraction and summarization.': 'Best for webpage content extraction and summarization.',
  'Best for repository and technical document reading.': 'Best for repository and technical document reading.',
  // Profile Settings
  'Name': 'Name',
